...
namespace VARANET.NetApiExt.Generated.Storage
{
    ...
    public sealed class GrandpaStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "State"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(VARANET.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Grandpa", "PendingChange"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(VARANET.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange)));
        ...
        ///  State of the current authority set.
        /// </summary>
        public async Task<VARANET.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState> State(CancellationToken token)
        {
            string parameters = GrandpaStorage.StateParams();
            var result = await _client.GetStorageAsync<VARANET.NetApiExt.Generated.Model.pallet_grandpa.EnumStoredState>(parameters, token);
            return result;
        }
        ...
        ///  Pending change: (signaled at, scheduled change).
        /// </summary>
        public async Task<VARANET.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange> PendingChange(CancellationToken token)
        {
            string parameters = GrandpaStorage.PendingChangeParams();
            var result = await _client.GetStorageAsync<VARANET.NetApiExt.Generated.Model.pallet_grandpa.StoredPendingChange>(parameters, token);
            return result;
        }
    ...
    public sealed class GrandpaCalls
    {
        ...
        /// </summary>
        public static Method ReportEquivocation(VARANET.NetApiExt.Generated.Model.sp_consensus_grandpa.EquivocationProof equivocation_proof, Substrate.NetApi.Model.Types.Base.BaseVoid key_owner_proof)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ReportEquivocationUnsigned(VARANET.NetApiExt.Generated.Model.sp_consensus_grandpa.EquivocationProof equivocation_proof, Substrate.NetApi.Model.Types.Base.BaseVoid key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
