    ...
    public sealed class GearGasStorage
    {
        ...
        public GearGasStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GearGas", "GasNodes"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(VARANET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNodeId), typeof(VARANET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode)));
        ...
        /// >> GasNodesParams
        /// </summary>
        public static string GasNodesParams(VARANET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNodeId key)
        {
        ...
        /// >> GasNodes
        /// </summary>
        public async Task<VARANET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode> GasNodes(VARANET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNodeId key, CancellationToken token)
        {
            string parameters = GearGasStorage.GasNodesParams(key);
            var result = await _client.GetStorageAsync<VARANET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode>(parameters, token);
            return result;
        }
