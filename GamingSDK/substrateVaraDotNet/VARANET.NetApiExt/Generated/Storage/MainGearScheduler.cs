    ...
    public sealed class GearSchedulerStorage
    {
        ...
        public GearSchedulerStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("GearScheduler", "TaskPool"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, VARANET.NetApiExt.Generated.Model.gear_common.scheduler.task.EnumScheduledTask>), typeof(Substrate.NetApi.Model.Types.Base.BaseTuple)));
        }
        ...
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> FirstIncompleteTasksBlock(CancellationToken token)
        {
        ...
        /// >> TaskPoolParams
        /// </summary>
        public static string TaskPoolParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, VARANET.NetApiExt.Generated.Model.gear_common.scheduler.task.EnumScheduledTask> key)
        {
        ...
        /// >> TaskPool
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple> TaskPool(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, VARANET.NetApiExt.Generated.Model.gear_common.scheduler.task.EnumScheduledTask> key, CancellationToken token)
        {
