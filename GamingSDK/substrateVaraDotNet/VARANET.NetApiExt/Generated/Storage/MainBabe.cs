...
namespace VARANET.NetApiExt.Generated.Storage
{
    ...
    public sealed class BabeStorage
    {
        ...
        public BabeStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "Authorities"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(VARANET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "GenesisSlot"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(VARANET.NetApiExt.Generated.Model.sp_consensus_slots.Slot)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "CurrentSlot"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(VARANET.NetApiExt.Generated.Model.sp_consensus_slots.Slot)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "Randomness"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(VARANET.NetApiExt.Generated.Types.Base.Arr32U8)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "PendingEpochConfigChange"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(VARANET.NetApiExt.Generated.Model.sp_consensus_babe.digests.EnumNextConfigDescriptor)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "NextRandomness"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(VARANET.NetApiExt.Generated.Types.Base.Arr32U8)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "NextAuthorities"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(VARANET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "UnderConstruction"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(VARANET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT1)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "Initialized"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseOpt<VARANET.NetApiExt.Generated.Model.sp_consensus_babe.digests.EnumPreDigest>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "AuthorVrfRandomness"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseOpt<VARANET.NetApiExt.Generated.Types.Base.Arr32U8>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "EpochConfig"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(VARANET.NetApiExt.Generated.Model.sp_consensus_babe.BabeEpochConfiguration)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "NextEpochConfig"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(VARANET.NetApiExt.Generated.Model.sp_consensus_babe.BabeEpochConfiguration)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Babe", "SkippedEpochs"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(VARANET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT2)));
        }
        ...
        ///  Current epoch authorities.
        /// </summary>
        public async Task<VARANET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1> Authorities(CancellationToken token)
        {
            string parameters = BabeStorage.AuthoritiesParams();
            var result = await _client.GetStorageAsync<VARANET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1>(parameters, token);
            return result;
        }
        ...
        ///  until the first block of the chain.
        /// </summary>
        public async Task<VARANET.NetApiExt.Generated.Model.sp_consensus_slots.Slot> GenesisSlot(CancellationToken token)
        {
            string parameters = BabeStorage.GenesisSlotParams();
            var result = await _client.GetStorageAsync<VARANET.NetApiExt.Generated.Model.sp_consensus_slots.Slot>(parameters, token);
            return result;
        }
        ...
        ///  Current slot number.
        /// </summary>
        public async Task<VARANET.NetApiExt.Generated.Model.sp_consensus_slots.Slot> CurrentSlot(CancellationToken token)
        {
        ...
        ///  adversary, for purposes such as public-coin zero-knowledge proofs.
        /// </summary>
        public async Task<VARANET.NetApiExt.Generated.Types.Base.Arr32U8> Randomness(CancellationToken token)
        {
            string parameters = BabeStorage.RandomnessParams();
            var result = await _client.GetStorageAsync<VARANET.NetApiExt.Generated.Types.Base.Arr32U8>(parameters, token);
            return result;
        }
        ...
        ///  Pending epoch configuration change that will be applied when the next epoch is enacted.
        /// </summary>
        public async Task<VARANET.NetApiExt.Generated.Model.sp_consensus_babe.digests.EnumNextConfigDescriptor> PendingEpochConfigChange(CancellationToken token)
        {
            string parameters = BabeStorage.PendingEpochConfigChangeParams();
            var result = await _client.GetStorageAsync<VARANET.NetApiExt.Generated.Model.sp_consensus_babe.digests.EnumNextConfigDescriptor>(parameters, token);
            return result;
        }
        ...
        ///  Next epoch randomness.
        /// </summary>
        public async Task<VARANET.NetApiExt.Generated.Types.Base.Arr32U8> NextRandomness(CancellationToken token)
        {
        ...
        ///  Next epoch authorities.
        /// </summary>
        public async Task<VARANET.NetApiExt.Generated.Model.bounded_collections.weak_bounded_vec.WeakBoundedVecT1> NextAuthorities(CancellationToken token)
        {
        ...
        ///  TWOX-NOTE: `SegmentIndex` is an increasing integer, so this is okay.
        /// </summary>
        public async Task<VARANET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT1> UnderConstruction(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = BabeStorage.UnderConstructionParams(key);
            var result = await _client.GetStorageAsync<VARANET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT1>(parameters, token);
            return result;
        }
        ...
        ///  if per-block initialization has already been called for current block.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<VARANET.NetApiExt.Generated.Model.sp_consensus_babe.digests.EnumPreDigest>> Initialized(CancellationToken token)
        {
            string parameters = BabeStorage.InitializedParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<VARANET.NetApiExt.Generated.Model.sp_consensus_babe.digests.EnumPreDigest>>(parameters, token);
            return result;
        }
        ...
        ///  It is set in `on_finalize`, before it will contain the value from the last block.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<VARANET.NetApiExt.Generated.Types.Base.Arr32U8>> AuthorVrfRandomness(CancellationToken token)
        {
            string parameters = BabeStorage.AuthorVrfRandomnessParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<VARANET.NetApiExt.Generated.Types.Base.Arr32U8>>(parameters, token);
            return result;
        }
        ...
        ///  genesis.
        /// </summary>
        public async Task<VARANET.NetApiExt.Generated.Model.sp_consensus_babe.BabeEpochConfiguration> EpochConfig(CancellationToken token)
        {
            string parameters = BabeStorage.EpochConfigParams();
            var result = await _client.GetStorageAsync<VARANET.NetApiExt.Generated.Model.sp_consensus_babe.BabeEpochConfiguration>(parameters, token);
            return result;
        }
        ...
        ///  (you can fallback to `EpochConfig` instead in that case).
        /// </summary>
        public async Task<VARANET.NetApiExt.Generated.Model.sp_consensus_babe.BabeEpochConfiguration> NextEpochConfig(CancellationToken token)
        {
        ...
        ///  active epoch index was during that session.
        /// </summary>
        public async Task<VARANET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT2> SkippedEpochs(CancellationToken token)
        {
            string parameters = BabeStorage.SkippedEpochsParams();
            var result = await _client.GetStorageAsync<VARANET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT2>(parameters, token);
            return result;
        }
    }
    ...
    public sealed class BabeCalls
    {
        ...
        /// </summary>
        public static Method ReportEquivocation(VARANET.NetApiExt.Generated.Model.sp_consensus_slots.EquivocationProof equivocation_proof, Substrate.NetApi.Model.Types.Base.BaseVoid key_owner_proof)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ReportEquivocationUnsigned(VARANET.NetApiExt.Generated.Model.sp_consensus_slots.EquivocationProof equivocation_proof, Substrate.NetApi.Model.Types.Base.BaseVoid key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method PlanConfigChange(VARANET.NetApiExt.Generated.Model.sp_consensus_babe.digests.EnumNextConfigDescriptor config)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
