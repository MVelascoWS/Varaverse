...
namespace VARANET.RestService.Generated.Storage
{
    ...
    public interface ISessionStorage : IStorage
    {
        ...
        /// </summary>
        Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<VARANET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, VARANET.NetApiExt.Generated.Model.gear_runtime.SessionKeys>> GetQueuedKeys();
        ...
        /// </summary>
        VARANET.NetApiExt.Generated.Model.gear_runtime.SessionKeys GetNextKeys(string key);
        
        /// <summary>
        /// >> KeyOwner
        ///  The owner of a key. The key is the `KeyTypeId` + the encoded key.
        /// </summary>
        VARANET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetKeyOwner(string key);
    }
    ...
    public sealed class SessionStorage : ISessionStorage
    {
        ...
        /// </summary>
        private TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<VARANET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, VARANET.NetApiExt.Generated.Model.gear_runtime.SessionKeys>>> _queuedKeysTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<VARANET.NetApiExt.Generated.Model.gear_runtime.SessionKeys> _nextKeysTypedStorage;
        
        /// <summary>
        /// _keyOwnerTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<VARANET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _keyOwnerTypedStorage;
        ...
        {
            this.ValidatorsTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<VARANET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>>("Session.Validators", storageDataProvider, storageChangeDelegates);
            ...
            this.QueuedKeysTypedStorage = new TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<VARANET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, VARANET.NetApiExt.Generated.Model.gear_runtime.SessionKeys>>>("Session.QueuedKeys", storageDataProvider, storageChangeDelegates);
            ...
            this.NextKeysTypedStorage = new TypedMapStorage<VARANET.NetApiExt.Generated.Model.gear_runtime.SessionKeys>("Session.NextKeys", storageDataProvider, storageChangeDelegates);
            this.KeyOwnerTypedStorage = new TypedMapStorage<VARANET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("Session.KeyOwner", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedStorage<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<VARANET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, VARANET.NetApiExt.Generated.Model.gear_runtime.SessionKeys>>> QueuedKeysTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<VARANET.NetApiExt.Generated.Model.gear_runtime.SessionKeys> NextKeysTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<VARANET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> KeyOwnerTypedStorage
        {
            get
            {
        ...
        ///  will be used to determine the validator's session keys.
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<VARANET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, VARANET.NetApiExt.Generated.Model.gear_runtime.SessionKeys>> GetQueuedKeys()
        {
        ...
        ///  The next session keys for a validator.
        /// </summary>
        public VARANET.NetApiExt.Generated.Model.gear_runtime.SessionKeys GetNextKeys(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (NextKeysTypedStorage.Dictionary.TryGetValue(key, out VARANET.NetApiExt.Generated.Model.gear_runtime.SessionKeys result))
            {
                return result;
            }
            else
        ...
        ///  The owner of a key. The key is the `KeyTypeId` + the encoded key.
        /// </summary>
        public VARANET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetKeyOwner(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (KeyOwnerTypedStorage.Dictionary.TryGetValue(key, out VARANET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 result))
            {
                return result;
            }
            else
