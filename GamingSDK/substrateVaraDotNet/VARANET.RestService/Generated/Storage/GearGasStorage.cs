...
namespace VARANET.RestService.Generated.Storage
{
    ...
    public interface IGearGasStorage : IStorage
    {
        ...
        /// >> GasNodes
        /// </summary>
        VARANET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode GetGasNodes(string key);
    ...
    public sealed class GearGasStorage : IGearGasStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<VARANET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode> _gasNodesTypedStorage;
        ...
        public GearGasStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.GasNodesTypedStorage = new TypedMapStorage<VARANET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode>("GearGas.GasNodes", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<VARANET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode> GasNodesTypedStorage
        {
            get
            {
        ...
        /// >> GasNodes
        /// </summary>
        public VARANET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode GetGasNodes(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (GasNodesTypedStorage.Dictionary.TryGetValue(key, out VARANET.NetApiExt.Generated.Model.gear_common.gas_provider.node.EnumGasNode result))
            {
                return result;
            }
            else
