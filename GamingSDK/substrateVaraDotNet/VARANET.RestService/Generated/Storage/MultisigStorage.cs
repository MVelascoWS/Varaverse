...
namespace VARANET.RestService.Generated.Storage
{
    ...
    public interface IMultisigStorage : IStorage
    {
        ...
        /// </summary>
        VARANET.NetApiExt.Generated.Model.pallet_multisig.Multisig GetMultisigs(string key);
    }
    ...
    public sealed class MultisigStorage : IMultisigStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<VARANET.NetApiExt.Generated.Model.pallet_multisig.Multisig> _multisigsTypedStorage;
        ...
        {
            this.MultisigsTypedStorage = new TypedMapStorage<VARANET.NetApiExt.Generated.Model.pallet_multisig.Multisig>("Multisig.Multisigs", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _multisigsTypedStorage property
        /// </summary>
        public TypedMapStorage<VARANET.NetApiExt.Generated.Model.pallet_multisig.Multisig> MultisigsTypedStorage
        {
            get
            {
        ...
        ///  The set of open multisig operations.
        /// </summary>
        public VARANET.NetApiExt.Generated.Model.pallet_multisig.Multisig GetMultisigs(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (MultisigsTypedStorage.Dictionary.TryGetValue(key, out VARANET.NetApiExt.Generated.Model.pallet_multisig.Multisig result))
            {
                return result;
            }
            else
